...
18. **[ ] Prompt:** _"Provision the CI secrets required for builds and publishing."_
    ...
    - **Prerequisites:** Tasks 16 (Play App Signing + service account JSON) and 17 (Gradle release signing + upload keystore) are completed.
    - **Dependency:** Provision CI secrets only after the Play signing configuration and upload keystore from Tasks 16–17 are finalized.
    - **Steps:**
